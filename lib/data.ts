...
export const projects = [
  ...
  },
  {
    ...
    tag: "Web3",
    description:
      "Owned frontend architecture and smart contract integrations for token presales. First hands-on experience bridging blockchain logic with user-facing UX.",
  },
];
...
export const howIThink = [
  ...
  "Business impact, not just code quality",
...
export const experience = [
  ...
  },
  {
    ...
    tech: ["Vue.js", "REST APIs"],
    industry: "Industrial / E-Learning",
    current: false,
  },
  {
    company: "Mudey",
